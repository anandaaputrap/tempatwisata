            ...
            <ul class="nav-menu custom-scrollbar">
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        <li><a href="dashboard.html" class="">Default</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        ...
                        <li><a href="ui-kits/helper-classes.html" class="">helper classes</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-sub-childmenu submenu-content" style="display: none;">
                                <li><a href="ui-kits/tab-bootstrap.html" class="">Bootstrap
                                        Tabs</a></li>
                                <li><a href="ui-kits/tab-material.html" class="">Line Tabs</a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        ...
                        <li>
                            ...
                            <ul class="nav-sub-childmenu submenu-content" style="display: none;">
                                <li><a href="bonus-ui/timeline-v-1.html" class="">Timeline 1</a>
                                </li>
                                <li><a href="bonus-ui/timeline-v-2.html" class="">Timeline 2</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        ...
                        <li><a href="charts/chart-sparkline.html" class="">Sparkline chart</a>
                        </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        ...
                        <li><a href="form-controls/input-group.html" class="">Input Groups</a>
                        </li>
                        <li><a href="form-controls/megaoptions.html" class="">Mega Options </a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        <li><a href="form-layout/default-form.html" class="">Default Forms</a>
                        </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        <li><a href="bootstrap-tables/bootstrap-basic-table.html" class="">Basic
                                Tables</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        <li><a href="ex-data-tables/datatable-ext-autofill.html" class="">Auto
                                Fill</a></li>
                        ...
                        <li><a href="ex-data-tables/datatable-ext-key-table.html" class="">Key
                                Table</a></li>
                        <li><a href="ex-data-tables/datatable-ext-responsive.html"
                                class="">Responsive</a></li>
                        <li><a href="ex-data-tables/datatable-ext-row-reorder.html" class="">Row
                                Reorder</a></li>
                ...
                <li>
                    <a class="nav-link menu-title link-nav active" href="sample-page.html"><i
                            ...
                            <div class="row">
                                    ...
                                    <div class="link-section">
                                        ...
                                        <div class="submenu-content opensubmegamenu">
                                            <ul>
                                                ...
                                                <li><a href="creat-password.html" class="">Creat
                                                        Password</a></li>
                                ...
                                <div class="col mega-box">
                                    <div class="link-section">
                                        ...
                                        <div class="submenu-content opensubmegamenu">
                                            <ul>
                                                <li><a href="basic-template.html" class="">Basic
                                                        Email</a></li>
                                                <li><a href="email-header.html" class="">Basic
                                                        With Header</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        ...
                        <li><a href="gallery/gallery-with-description.html" class="">Gallery
                                Grid Desc</a></li>
                        <li><a href="gallery/gallery-masonry.html" class="">Masonry Gallery</a>
                        </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: none;">
                        ...
                        <li><a href="editors/ace-code-editor.html" class="">ACE code editor</a>
                        </li>
                    </ul>
                </li>
                <li>
