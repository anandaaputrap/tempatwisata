...
<div class="edit-profile">
    <div class="row">
        <div class="card col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="jarak"
                                        placeholder="Jarak" />
                                </div>
                            </div>
                            <div class="col-md-4">
            ...
            @else
                <form action="{{ route('kriteria-jarak.update', $data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-header pb-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Jarak</label>
                                    <input class="form-control" type="text" value="{{ $data->jarak }}" name="jarak"
                                        placeholder="Jarak" />
                                </div>
                            </div>
                            <div class="col-md-4">
