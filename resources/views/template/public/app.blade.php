...
<html lang="en">
  ...
  <body>
    ...
    <section
      id="about"
      class="about-section about-style-two pt-100 pb-70 bg-light"
    >
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="about-content mb-30">
              ...
              <h6 style="text-align: justify">
                ...
                Sektor Perkebunan komoditi unggulannya adalah Kakao, Kopi, Kelapa, Cengkeh, Jambu Mete, dan Pala.
                Sub sektor Pertanian komoditi yang diunggulkan berupa Jagung dan Ubi Kayu. Sub sektor jasa yaitu Pariwisata.
              </h6>
              <div class="row">
          ...
          <div class="col-lg-6">
            <div class="video-content mb-30">
              ...
              <a
                href="https://www.youtube.com/watch?v=3iG2zwMdRjc"
