                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="gender">
                                        ...
                                        <option value="Laki" {{ old('gender', $data->gender) == "Laki" ? 'selected' : null}}>Laki</option>
                                        <option value="Perempuan" {{ old('gender', $data->gender) == "Perempuan" ? 'selected' : null}}>Perempuan</option>
                                    </select>
                                </div>
                            </div>
                        </div>
